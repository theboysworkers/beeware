...
CREATE USER IF NOT EXISTS 'roundcubeuser'@'%' IDENTIFIED BY 'password';
CREATE DATABASE IF NOT EXISTS roundcubemail CHARACTER SET utf8 COLLATE utf8_general_ci;
GRANT ALL PRIVILEGES ON roundcubemail.* TO 'roundcubeuser'@'%';
...
-- Dump completed on 2025-10-02 16:54:36
