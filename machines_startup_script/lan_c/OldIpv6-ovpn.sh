...
# ========================================
# OpenVPN + Easy-RSA Automated Setup Script (IPv6-Only, for Docker/LXC)
# ========================================
...
# ================================
#  IPv6 OpenVPN server configuration
# ================================
...
# No iptables / NAT needed in IPv6-only mode
echo "🚫 Skipping IPv4 NAT setup (IPv6-only mode)"

# ================================
#  Start OpenVPN
# ================================
echo "🚀 Starting OpenVPN (IPv6 mode)..."
...
echo "✅ OpenVPN IPv6 setup complete!"
echo "Client config available at: $CLIENT_OVPN"
