...
ip link set dev eth1 master mainbridge   # Interface connected to cisco-d
ip link set dev eth2 master mainbridge   # Interface connected to pc1d
...
echo "ListenAddress fe80::200:ff:fe00:f5%eth0" >> /etc/ssh/sshd_config
