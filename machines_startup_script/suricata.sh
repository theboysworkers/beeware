...
# ip address add 2a04::100/64 dev eth0
# ip address add 2a04:0:0:1::100/64 dev eth1
# ip address add 2a04:0:0:2::100/64 dev eth1
# ip address add 2a04:0:0:2::100/64 dev eth1

# Set the default IPv6 gateway via 2a04:0:0:0::1 on interface eth1
# ip -6 route add default via 2a04:0:0:0000::1 dev eth0
# ip -6 route add default via 2a04:0:0:1::1 dev eth1
# ip -6 route add default via 2a04:0:0:2::1 dev eth2
# ip -6 route add default via 2a04:0:0:1::1 dev eth3
# ip -6 route add default via 2a04:0:0:2::1 dev eth4
